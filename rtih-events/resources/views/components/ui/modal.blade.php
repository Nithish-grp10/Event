<div x-data="{ show: @entangle($attributes->wire('model')) }" x-show="show" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="display: none;">
